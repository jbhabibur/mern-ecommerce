...
//         phone: addr.phoneNumber || "", // Correct: addr.phoneNumber -> phone
//         division: addr.division || "",
//         city: addr.city || "",
//         zone: addr.zone || "",
//         address: addr.houseAddress || "", // Correct: addr.houseAddress -> address
//         landmark: addr.landmark || "",
//         label: addr.label || "HOME",
//       },
//       // Billing sections-o eki bhabe mapping hobe
//       billing: {
//         fullName: addr.fullName || "",
...
//     () =>
//       // FIX: Access division from the 'shipping' sub-object
//       formData.shipping?.division
//         ? Object.keys(BD_LOCATIONS[formData.shipping.division] || {})
//         : [],
//     [formData.shipping?.division],
//   );
...
//     () =>
//       // FIX: Access division and city from the 'shipping' sub-object
//       formData.shipping?.division && formData.shipping?.city
//         ? BD_LOCATIONS[formData.shipping.division][formData.shipping.city] || []
//         : [],
//     [formData.shipping?.division, formData.shipping?.city],
//   );
...
//             {/* Address Details */}
//             <div className="flex-1 min-w-0 pr-2 bg-amber-300">
    ...
    <div className="w-full font-sans border-b border-[#DEDEDE] pb-2">
      ...
      <AddressModal
        ...
        handleLocationChange={
          handleDivisionChange && handleCityChange
            ? (section, type, val) => {
                if (type === "division") handleDivisionChange(val);
                if (type === "city") handleCityChange(val);
              }
            : null
        }
        divisionOptions={divisionOptions}
